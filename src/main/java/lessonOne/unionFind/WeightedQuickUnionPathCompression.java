...
import utilsPrinceton.StdIn;
import utilsPrinceton.StdOut;
...
public class WeightedQuickUnionPathCompression {
    ...
    public int find(int p) {
        while (p != id[p])
            ...
            // We get all the elements to point to the grandparent, thus halving the path //
            // Pointing to root would be ideal, but in practice this has the same effect //
            // and is achieved in one line of code //
            id[p] = id[id[p]];
            //****************** SIMPLY BRILLIANT - OFFER LINEAR PERFORMANCE *******//
            p = id[p];
        return p;
    }
