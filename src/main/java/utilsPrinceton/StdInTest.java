/**
 * Test client for StdIn and FileIn.
 **/
...
public class StdInTest {
    ...
    /**
     * FileIn the two methods below, each Object[] of "steps" is a length-2
    ...
    public static void main(String[] args) {
        ...
        if (testStdIn) 
            ...
            StdOut.println("Note: StdIn.resync is private, only FileIn will be tested.");
