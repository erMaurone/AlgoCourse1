/*************************************************************************
 *  Compilation:  javac FileIn.java
 *  Execution:    java FileIn   (basic test --- see source for required files)
 *
 *  Reads in data of various types from standard input, files, and URLs.
 *
 *************************************************************************/
package utilsPrinceton;
...
public final class In {
    ...
    /*** begin: section (1 of 2) of code duplicated from FileIn to StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from FileIn to StdIn */
   ...
   /**
    ...
    /*** begin: section (2 of 2) of code duplicated from FileIn to StdIn,
   ...
   /**
    ...
    public char readChar() {
        ...
        assert (ch.length() == 1) : "Internal (Std)FileIn.readChar() error!"
   ...
   /**
    ...
    /*** end: section (2 of 2) of code duplicated from FileIn to StdIn */
   ...
   /**
     ...
     * <tt>new FileIn(filename)</tt>.{@link #readAllInts()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use 
     * <tt>new FileIn(filename)</tt>.{@link #readAllDoubles()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use 
     * <tt>new FileIn(filename)</tt>.{@link #readAllStrings()}
     */
